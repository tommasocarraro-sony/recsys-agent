...
3. When performing item filtering, if corrections have been made on the filters to find matching items, please explain the user which corrections you had to perform. Remember to explain the corrections **before** showing the tool results. The tool might return both successful and tried but failed user condition correction attempts. Please, **explain** all of them.
